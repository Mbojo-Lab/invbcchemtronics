...
$q = "SELECT wh_name,DATE_FORMAT(date,'%d/%m/%Y') AS date,KdBarang AS KdBarang3,KdBarang AS KdBarang2, NmBarang AS NmBarang2,Ket,Sat AS Sat2,FORMAT(qty, 2) AS qty,IFNULL(FORMAT(weight, 2),0) AS weight
	  FROM mst_barang a 
...
$html = '<h2 align="center">'.$NmMenu.'</h2>'.		
		...
		<tr>
		  ...
		  <th width="100"><b>Item Description</b></th>		  
...
$html .= '<tr>'.
		 ...
		 '<td width="100">'.$r['Item Description'].'</td>'.
