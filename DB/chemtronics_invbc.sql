...
CREATE TABLE `mat_inchdr` (
  ...
  `tot_weight` decimal(9,0) NOT NULL DEFAULT '0' COMMENT 'Jumlah Dalam Bentuang Rupiah',
...
CREATE TABLE `mat_opnamehdr` (
  ...
  `tot_weight` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `mkt_dohdr` (
  ...
  `tot_weight` decimal(9,2) DEFAULT NULL,
...
CREATE TABLE `pur_pohdr` (
  ...
  `tot_weight` decimal(10,2) NOT NULL COMMENT 'Nilai setelah dikurangi Diskon, ditambah PPn',
