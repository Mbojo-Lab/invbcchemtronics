...
$(function(){
	$('#dg').datagrid({
		...
		columns:[[  
			...
			{field:'supplier',title:'Pemasok/Pengirim',rowspan:2,width:40}, 
			...
			{field:'matin_no',title:'Nomor',width:30,align:"center"},
			{field:'matin_date',title:'Tanggal',width:25,align:'center'}			
		]],
