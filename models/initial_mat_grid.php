...
if ($req=='menu'){
	...
	$q = "SELECT KdBarang AS KdBarang3,KdBarang AS KdBarang2, NmBarang AS NmBarang2,twhmp,Ket,Sat AS Sat2,FORMAT(qty, 2) AS qty,IFNULL(FORMAT(weight, 2),0) AS weight
		  FROM mst_barang a 
