...
if ($req=='menu'){
	...
	$q = "SELECT KdBarang AS KdBarang3,mat_id AS KdBarang2, NmBarang AS NmBarang2,twhmp,HsNo AS HsNo2,Sat AS Sat2,FORMAT(qty, 2) AS qty,FORMAT(price, 4) AS price,FORMAT(qty*price, 2) AS amount,FORMAT(weight, 2) AS weight
		  FROM mat_incdet a 
